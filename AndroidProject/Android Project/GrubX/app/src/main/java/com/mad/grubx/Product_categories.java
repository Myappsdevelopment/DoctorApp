...
public class Product_categories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadGridDataAdapter = new LoadGridDataAdapter(this, R.layout.category_gridview_item, arrayList);
        category_grid.setAdapter(loadGridDataAdapter);
    }

    private void init() {
        category_grid = findViewById(R.id.category_gridview);
