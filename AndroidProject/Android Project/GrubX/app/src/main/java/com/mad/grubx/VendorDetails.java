...
public class VendorDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VendorDetailsListAdapter mAdapter = new VendorDetailsListAdapter(getApplicationContext(), datamodel);
    ...
    private void init() {
        ...
        recyclerView=findViewById(R.id.recycler_vendor_details);
    ...
    private void PagerView() {
        ...
        mPager.setAdapter(new SlidingImage_Adapter(VendorDetails.this, ImagesArray));
...
//Set circle indicator radius
    ...
    private class VendorDetailsListAdapter extends RecyclerView.Adapter<ViewHolder> {

        Context context;
        private List<DataModel> data1;

        public VendorDetailsListAdapter(Context context, List<DataModel> datamodel) {
            this.context = context;
