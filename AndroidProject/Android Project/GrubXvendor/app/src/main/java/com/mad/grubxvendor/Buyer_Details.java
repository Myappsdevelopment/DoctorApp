...
public class Buyer_Details extends AppCompatActivity {
    ...
    private void PagerView() {
        ...
        mPager.setAdapter(new SlidingImage_Adapter(Buyer_Details.this, ImagesArray));
...
//Set circle indicator radius
    ...
    private void Data() {
        ...
        DataModel data = new DataModel(R.drawable.img3, "", "Cidre Apple", "300", "320");
        datamodel.add(data);

        data = new DataModel(R.drawable.img2, "", "Iced Tea, Brisk", "150", "160");
        datamodel.add(data);

        data = new DataModel(R.drawable.img2, "", "Iced Tea, Brisk", "150", "160");
        datamodel.add(data);

        data = new DataModel(R.drawable.img3, "", "Cidre Apple", "300", "320");
        datamodel.add(data);
    ...
    private class ProductDetailsListAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_view_buyerdetails, parent, false);
    ...
    private class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView  amount, disc_amount,prd_name;
        ImageView img;
        CardView crd;
